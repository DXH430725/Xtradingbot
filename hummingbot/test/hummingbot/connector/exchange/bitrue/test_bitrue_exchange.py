...
class BitrueExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def all_symbols_including_invalid_pair_mock_response(self) -> Tuple[str, Any]:
        response = {
            ...
            "coins": [{"coin": "ksm", "coinFulName": "Kusama", "chains": ["KSM"], "chainDetail": []}],
        }
            ...
            "B": [
                {
                    ...
                    "F": "10",
                    "T": 1707847406000,
                    "f": "-19.9332000000000000",
                    "L": "5",
                    "l": "19.9332000000000000",
                    "t": 1707847406000,
                }
            ],
            "u": 3491219,
    ...
    def expected_trading_rule(self):
        return TradingRule(
            ...
            min_order_size=Decimal(self.trading_rules_request_mock_response["symbols"][0]["filters"][2]["minQty"]),
            min_price_increment=Decimal(
                self.trading_rules_request_mock_response["symbols"][0]["filters"][0]["tickSize"]
            ),
            min_base_amount_increment=Decimal(
                self.trading_rules_request_mock_response["symbols"][0]["filters"][2]["stepSize"]
            ),
            min_notional_size=Decimal(self.trading_rules_request_mock_response["symbols"][0]["filters"][2]["minVal"]),
        )
    ...
    def validate_order_creation_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(BitrueExchange.bitrue_order_type(OrderType.LIMIT), request_data["type"])
    ...
    def validate_trades_request(self, order: InFlightOrder, request_call: RequestCall):
        request_params = request_call.kwargs["params"]
        self.assertEqual(self.exchange_symbol_for_tokens(self.base_asset, self.quote_asset), request_params["symbol"])
        self.assertEqual("1000", str(request_params["limit"]))
    ...
    def configure_order_not_found_error_cancelation_response(
        ...
        url = web_utils.private_rest_url(CONSTANTS.ORDER_PATH_URL)
        regex_url = re.compile(f"^{url}".replace(".", r"\.").replace("?", r"\?"))
        response = {"code": CONSTANTS.ORDER_NOT_FOUND_ERROR_CODE, "msg": "Unknown order sent."}
    ...
    def order_event_for_new_order_websocket_update(self, order: InFlightOrder):
        return {
            ...
            "E": 1707846462226,
            "iStr": "512187109456805888",
            "I": 512187109578440706,
            "u": 3491219,
    ...
    def test_time_synchronizer_related_request_error_detection(self):
        exception = IOError(
            "Error executing request POST https://api.bitrue.com/api/v3/order. HTTP status is 400. "
        ...
        return [
            {
                ...
                "orderId": int(order.client_order_id),
                "price": str(order.price),
