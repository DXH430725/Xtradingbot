...
class BitrueAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.data_source = BitrueAPIOrderBookDataSource(
    ...
    def _order_diff_event(self):
        resp = {
            "channel": "market_coinalphahbot_simple_depth_step0",
            "tick": {"bids": [["0.0024", "10"]], "asks": [["0.0026", "100"]]},
            "ts": 123456789000,
        }
        return resp
    ...
    async def test_listen_for_subscriptions_subscribes_to_trades_and_order_diffs(self, ws_connect_mock):
        ...
        expected_diff_subscription = {
            "event": "sub",
            "params": {"cb_id": "coinalphahbot", "channel": "market_coinalphahbot_simple_depth_step0"},
        }
