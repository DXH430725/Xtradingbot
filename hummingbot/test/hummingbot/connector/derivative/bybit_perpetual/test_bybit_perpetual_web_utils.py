...
class BybitPerpetualWebUtilsTest(unittest.TestCase):
    def test_get_rest_url_for_endpoint(self):
        ...
        url = web_utils.get_rest_url_for_endpoint(endpoint, trading_pair=linear_pair, domain="bybit_perpetual_main")
        self.assertEqual("https://api.bybit.com/testEndpoint/linear", url)

        url = web_utils.get_rest_url_for_endpoint(endpoint, trading_pair=linear_pair, domain="bybit_perpetual_testnet")
        self.assertEqual("https://api-testnet.bybit.com/testEndpoint/linear", url)

        url = web_utils.get_rest_url_for_endpoint(endpoint, trading_pair=non_linear_pair, domain="bybit_perpetual_main")
