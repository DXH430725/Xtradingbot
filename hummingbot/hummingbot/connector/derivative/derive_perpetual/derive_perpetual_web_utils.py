...
def rest_url(path_url: str, domain: str = "derive_perpetual"):
    base_url = CONSTANTS.BASE_URL if domain == "derive_perpetual" else CONSTANTS.TESTNET_BASE_URL
    return base_url + path_url


def wss_url(domain: str = "derive_perpetual"):
    base_ws_url = CONSTANTS.WSS_URL if domain == "derive_perpetual" else CONSTANTS.TESTNET_WSS_URL
    return base_ws_url
